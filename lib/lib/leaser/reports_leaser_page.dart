...
class _ReportsLeaserPageState extends State<ReportsLeaserPage> {
  ...
  Future<void> _generate() async {
    ...
    try {
      ...
      final m = await svc.loadLeaserMetrics(leaserId: widget.leaserId, start: s, end: e);
      final series = await svc.leaserDailySeries(leaserId: widget.leaserId, start: s, end: e);
      setState(() {
        _metrics = m;
        _series = series;
      });
