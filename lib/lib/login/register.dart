...
class _RegisterPageState extends State<RegisterPage> {
      ...
      if (authResponse?.user != null) {
        ...
        if (existingUser != null) {
          ...
          if (mounted) {
            ...
            // ✅ Security: do not keep session here; force user to login again.
            try {
        ...
        if (mounted) {
          ...
          // ✅ Security: do NOT keep user logged in after registration.
          try {
            await supabase.auth.signOut();
          } catch (_) {}
  ...
  Future<void> _signUpWithGoogle() async {
    ...
    try {
      // ✅ Use Supabase OAuth. After the browser returns, main.dart handles the deep link.
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Continue in your browser to sign in with Google...'),
            backgroundColor: Colors.green,
          ),
        );
      }
