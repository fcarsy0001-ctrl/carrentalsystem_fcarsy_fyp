  ...
  Future<void> _save() async {
    ...
    try {
      ...
      try {
        ...
        // Storage bucket/policy not ready: allow vehicle creation without photo.
        photoPath = null;
      }
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Failed: $e\n\nTip: This usually means one field is longer than your DB column (e.g. varchar(10)). Try shorter IDs/location, or alter the column length in Supabase.',
          ),
      ...
      body: SafeArea(
        child: Form(
          ...
          child: ListView(
            ...
            children: [
              if ((widget.fixedLeaserId ?? '').trim().isEmpty) ...[
                TextFormField(
                ...
                // Leaser mode: show fixed leaser id (read-only)
                Container(
              ...
              Card(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      const Text('Vehicle photo (optional)', style: TextStyle(fontWeight: FontWeight.w800)),
                      const SizedBox(height: 10),
                      if (_photoBytes != null)
                        ClipRRect(
                          borderRadius: BorderRadius.circular(12),
