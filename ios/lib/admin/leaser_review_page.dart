                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(sub, style: const TextStyle(fontWeight: FontWeight.w700)),
...
class _LeaserAddPageState extends State<_LeaserAddPage> {
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      final authUid = (u?['auth_uid'] ?? '').toString().trim();
      if (userId.isEmpty) {
      ...
      await _supa.from('leaser').insert({
        'leaser_id': leaserId,
        'auth_uid': authUid.isEmpty ? null : authUid,
        'user_id': userId,
